...
3. Select your repository. Render will automatically detect [`server/render.yaml`](file:///Users/vinayak/Documents/antigravity/lively-davinci/server/render.yaml) and provision the service with a free TLS certificate (`wss://synqto-server.onrender.com/ws/`).
